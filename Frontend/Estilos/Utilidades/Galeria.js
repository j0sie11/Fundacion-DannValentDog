document.addEventListener('DOMContentLoaded', () =>{
    const contenedorP = document.getElementById('contGaleria');

   function mostrarGaleria(){ 
        fetch('/GaleriaDogs') //solicitud a la pagina en donde se encuentran los Adopciones en .JSON
        ...
        .then(Adopciones => {
            ...
            if(Adopciones.length === 0){ //Mira todos los Adopciones agregados y si pasa a mayor de 0 se muestra el adopcion
                contenedorP.innerHTML = '<h1 style="color: black;">No hay Fotos, Ni Videos</h1>';
                return;
            }
            ...
            <div class="ComPros">
                <div class="tabla">
                    ${adopcion.img2 ? `<img src="${adopcion.img2}" class="fotoDog" height="350px" width="350px">` : ''}
